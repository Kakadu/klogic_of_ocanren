                        ...
                        freshTypedVars { nh: Term<LogicList<LogicInt>>,
                            ...
                            freshTypedVars { qlmr: Term<LogicList<LogicInt>>,
                                ...
                                and(splito(n, r, nl, nh),
                                        splito(q, r, ql, qh),
                                        conde(((((nh `===` zero) and (qh `===` zero)) and minuso(nl,
                                                r,
                                                qlm)) and
                                                multo(ql, m, qlm)),
                                                (((((poso(nh) and multo(ql, m, qlm)) and pluso(qlm,
                                                        r,
                                                        qlmr)) and
                                                        minuso(qlmr, nl, rr)) and splito(rr, r,
                                                        zero, rh)) and
                                                        divo(nh, m, qh, rh))))
                            }
                        }))
...
fun logo(n: Term<LogicList<LogicInt>>, b: Term<LogicList<LogicInt>>,
        ...
        conde(and(n `===` one,
                ...
                and(b `===` zero,
                        poso(q),
                        r `===` n),
                (((0.toLogic() + (1.toLogic() + nilLogicList())) `===` b) and freshTypedVars { a: Term<LogicInt>,
                                                                                               ad: Term<LogicInt>,
                                                                                               dd: Term<LogicList<LogicInt>> ->
                    and(poso(dd),
                            n `===`
