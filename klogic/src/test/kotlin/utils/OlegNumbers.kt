...
fun  gen_addero(d: Term<LogicInt>, n: Term<LogicList<LogicInt>>,
      m: Term<LogicList<LogicInt>>, r: Term<LogicList<LogicInt>>): Goal =
  fresh { a : Term<LogicInt>  b : Term<LogicInt>  c : Term<LogicInt> 
   e : Term<LogicInt>  x : Term<LogicList<LogicInt>> ->
  freshTypedVars { y: Term<LogicList<LogicInt>> z: Term<LogicList<LogicInt>> ->
  and((a + x) `===` n,
      (b + y) `===` m,
      poso(y),
      (c + z) `===` r,
...
fun  bound_multo(q: Term<LogicList<LogicInt>>, p: Term<LogicList<LogicInt>>,
  ...
  conde(and(q `===` zero, poso(p)),
        fresh { a0 : Term<LogicInt>  a1 : Term<LogicInt>  a2 : Term<LogicInt> 
         a3 : Term<LogicInt>  x : Term<LogicList<LogicInt>> ->
        freshTypedVars { y: Term<LogicList<LogicInt>> z: Term<LogicList<LogicInt>> ->
        and(q `===` (a0 + x),
            p `===` (a1 + y),
            conde(and(n `===` zero,
...
fun  multo(n: Term<LogicList<LogicInt>>, m: Term<LogicList<LogicInt>>,
  ...
  conde(and(n `===` zero, p `===` zero),
        ...
        and(gt1o(n),
            m `===` one,
            n `===` p),
        freshTypedVars { x: Term<LogicList<LogicInt>> z: Term<LogicList<LogicInt>> ->
        and(n `===` (0.toLogic() + x),
            poso(x),
            p `===` (0.toLogic() + z),
            poso(z),
        ...
        freshTypedVars { x: Term<LogicList<LogicInt>> y: Term<LogicList<LogicInt>> ->
        and(n `===` (1.toLogic() + x),
            poso(x),
            m `===` (0.toLogic() + y),
            poso(y),
...
fun  splito(n: Term<LogicList<LogicInt>>, r: Term<LogicList<LogicInt>>,
  ...
  conde(and(n `===` zero,
        ...
        freshTypedVars { b: Term<LogicInt> n_: Term<LogicList<LogicInt>> 
          a: Term<LogicInt> r_: Term<LogicList<LogicInt>> l_: Term<LogicList<LogicInt>> ->
        and(n `===` (b + n_),
            r `===` (a + r_),
            l `===` (b + l_),
            poso(l_),
...
fun  divo(n: Term<LogicList<LogicInt>>, m: Term<LogicList<LogicInt>>,
  ...
  conde(and(r `===` n,
        ...
        and(ltlo(m n),
            lto(r m),
            poso(q),
            fresh { nh : Term<LogicList<LogicInt>>  nl : Term<LogicList<LogicInt>> 
             qh : Term<LogicList<LogicInt>>  ql : Term<LogicList<LogicInt>> 
             qlm : Term<LogicList<LogicInt>> ->
            freshTypedVars { qlmr: Term<LogicList<LogicInt>> rr: Term<LogicList<LogicInt>> 
...
fun  repeated_mul(n: Term<LogicList<LogicInt>>, q: Term<LogicList<LogicInt>>,
  ...
  conde(and(poso(n),
        ...
        and(q `===` one, n `===` nq),
        and(gt1o(q),
         freshTypedVars { q1: Term<LogicList<LogicInt>> nq1: Term<LogicList<LogicInt>> ->
         and(pluso(q1 one q),
...
fun  exp2(n: Term<LogicList<LogicInt>>, b: Term<LogicList<LogicInt>>,
  ...
  conde(and(n `===` one, q `===` zero),
        and(gt1o(n),
            ...
            splito(n b s one) }),
        freshTypedVars { q1: Term<LogicList<LogicInt>> b2: Term<LogicList<LogicInt>> ->
        and(q `===` (0.toLogic() + q1),
            poso(q1),
            ltlo(b n),
        ...
        freshTypedVars { q1: Term<LogicList<LogicInt>> nh: Term<LogicList<LogicInt>> 
          b2: Term<LogicList<LogicInt>> s: Term<LogicList<LogicInt>> ->
        and(q `===` (1.toLogic() + q1),
            poso(q1),
            poso(nh),
            splito(n b s nh),
...
fun  logo(n: Term<LogicList<LogicInt>>, b: Term<LogicList<LogicInt>>,
  ...
  conde(and(n `===` one,
        ...
        and(freshTypedVars { a: Term<LogicInt> ad: Term<LogicInt> add: Term<LogicInt> 
              ddd: Term<LogicList<LogicInt>> ->
            conde(b `===` three,
                  b `===` (a + (ad + (add + ddd))))
            },
            ltlo(b n),
            fresh { bw1 : Term<LogicList<LogicInt>>  bw : Term<LogicList<LogicInt>> 
             nw : Term<LogicList<LogicInt>>  nw1 : Term<LogicList<LogicInt>> 
             ql1 : Term<LogicList<LogicInt>> ->
            freshTypedVars { ql: Term<LogicList<LogicInt>> s: Term<LogicList<LogicInt>> ->
            and(exp2(b zero bw1),
                pluso(bw1 one bw),
                ltlo(q n),
                freshTypedVars { q1: Term<LogicList<LogicInt>> bwq1: Term<LogicList<LogicInt>> ->
                and(pluso(q one q1),
                    multo(bw q1 bwq1),
                    lto(nw1 bwq1))
                },
                ...
                pluso(ql one ql1),
                lelo(ql q),
                freshTypedVars { bql: Term<LogicList<LogicInt>> qh: Term<LogicList<LogicInt>> 
                  s2: Term<LogicList<LogicInt>> qdh: Term<LogicList<LogicInt>> 
                ...
                and(repeated_mul(b ql bql),
                    ...
                    pluso(ql qd q),
                    leo(qd qdh),
                    freshTypedVars { bqd: Term<LogicList<LogicInt>> bq1: Term<LogicList<LogicInt>> 
