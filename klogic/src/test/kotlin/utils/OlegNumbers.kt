...
context(RelationalContext) fun  zeroo(n: Term<LogicList<LogicInt>>): Goal =
n `===` nilLogicList()
context(RelationalContext) fun  poso(n: Term<LogicList<LogicInt>>): Goal =
...
context(RelationalContext) fun  gt1o(n: Term<LogicList<LogicInt>>): Goal =
      ...
      and(freshTypedVars { a: Term<LogicInt>, ad: Term<LogicInt>,
          ...
          and(exp2(b, zero, bw1),
              ...
              freshTypedVars { bql: Term<LogicList<LogicInt>>,
                qh: Term<LogicList<LogicInt>>, s2: Term<LogicList<LogicInt>>,
