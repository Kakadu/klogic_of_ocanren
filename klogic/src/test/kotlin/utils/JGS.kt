...
context(RelationalContext)
fun <B : Term<B>, A : Term<A>> mapo(
    f: (Term<A>, Term<B>) -> Goal,
    l: Term<LogicList<A>>, res: Term<LogicList<B>>
): Goal =
    conde(and(
        l `===` nilLogicList(),
        res `===` nilLogicList()
...
context(RelationalContext)
fun <B : Term<B>, A : Term<A>> mapio_helper(
    f: (Term<PeanoLogicNumber>, Term<A>, Term<B>) -> Goal,
    i: Term<PeanoLogicNumber>, l: Term<LogicList<A>>,
    res: Term<LogicList<B>>
): Goal =
    conde(and(
        l `===` nilLogicList(),
        res `===` nilLogicList()
...
context(RelationalContext)
fun <A : Term<A>> ntho(
    l: Term<LogicList<A>>, n: Term<PeanoLogicNumber>,
    rez: Term<A>
): Goal =
    freshTypedVars { hd: Term<A>, tl: Term<LogicList<A>> ->
        and(
...
context(RelationalContext)
fun <A : Term<A>> for_allo(
    p: (Term<A>, Term<LogicBool>) -> Goal,
    l: Term<LogicList<A>>, res: Term<LogicBool>
): Goal =
    conde(and(
        l `===` nilLogicList(),
        res `===` true.toLogicBool()
        ...
        freshTypedVars { hd: Term<A>, tl: Term<LogicList<A>>,
            ...
            and(
                ...
                conde(
                    and(
                        p_res `===` true.toLogicBool(),
                        for_allo(p, tl, res)
                    ),
                    and(
                        p_res `===` false.toLogicBool(),
                        res `===` false.toLogicBool()
                    )
                )
            )
...
context(RelationalContext)
fun <C : Term<C>, B : Term<B>, A : Term<A>> fold_left2o(
    f: (Term<A>, Term<B>, Term<C>, Term<A>) -> Goal,
...
context(RelationalContext)
fun <ID : Term<ID>> substitute_typ(
    subst: Term<LogicList<Jarg<Jtype<ID>>>>,
    typ: Term<Jtype<ID>>, res: Term<Jtype<ID>>
): Goal =
    conde(
        freshTypedVars { param: Term<Jtype<ID>>,
        ...
        freshTypedVars { id: Term<ID>,
            ...
            and(
                ...
                mapo(
                    { targ: Term<Jarg<Jtype<ID>>>, res: Term<Jarg<Jtype<ID>>> ->
...
context(RelationalContext)
fun <ID : Term<ID>> substitute_arg(
    subst: Term<LogicList<Jarg<Jtype<ID>>>>,
    targ: Term<Jarg<Jtype<ID>>>, res: Term<Jarg<Jtype<ID>>>
): Goal =
    conde(freshTypedVars { index: Term<PeanoLogicNumber> ->
        and(
            (targ `===` Type(Var(_f(), index, _f(), _f()))),
        ...
        freshTypedVars { p: Term<Polarity/*237*/>, typ: Term<Jtype<ID>>,
            ...
            and(
                targ `===` Wildcard(Some(LogicPair(p, typ))),
...
interface CLASSTABLE {
    ...
    context(RelationalContext)
    fun get_superclass_by_id(
        v3: Term<LogicInt>, v4: Term<LogicInt>,
...
interface VERIFIER {
    ...
    context(RelationalContext)
    fun raw_helper(
        v3: Term<LogicInt>, v4: Term<PeanoLogicNumber>,
    ...
    context(RelationalContext)
    fun subst_helper(
        v7: Term<ClosureConversionType<LogicInt>>,
        v8: Term<Jarg<Jtype<LogicInt>>>
    ): Goal

    // targs_helper
    context(RelationalContext)
    fun targs_helper(
        v9: Term<LogicList<Jarg<Jtype<LogicInt>>>>,
        v10: Term<ClosureConversionType<LogicInt>>,
        v11: Term<Jarg<Jtype<LogicInt>>>
    ): Goal
    ...
    fun targs_pred(
        ...
        v13: Term<Jarg<Jtype<LogicInt>>>, v14: Term<LogicBool>
    ): Goal
    ...
    fun capture_conversion(
        ...
        v18: Term<LogicOption<LogicList<Jarg<Jtype<LogicInt>>>>>
    ): Goal
...
val Verifier: (CLASSTABLE) -> VERIFIER = { CT: CLASSTABLE ->
    object : VERIFIER {
        ...
        override fun params(
            id: Term<LogicInt>,
            p: Term<LogicList<Jtype<LogicInt>>>
        ): Goal =
        ...
        context(RelationalContext)
        override fun raw_helper(
            id: Term<LogicInt>, i: Term<PeanoLogicNumber>,
            targ: Term<Jarg<Jtype<LogicInt>>>,
            cc_targ: Term<ClosureConversionType<LogicInt>>
        ): Goal =
            conde(freshTypedVars { t: Term<Jtype<LogicInt>> ->
                ...
                freshTypedVars { t: Term<Jtype<LogicInt>>,
                                 ...
                                 params_val: Term<LogicList<Jtype<LogicInt>>> ->
                    and(
                        targ `===` Wildcard(Some(LogicPair(Super(), t))),
                ...
                freshTypedVars { t: Term<Jtype<LogicInt>>,
                                 ...
                                 params_val: Term<LogicList<Jtype<LogicInt>>> ->
                    and(
                        targ `===` Wildcard(Some(LogicPair(Extends(), t))),
                        cc_targ `===` CC_var(
                            CT.new_var(), i, CC_subst.cc_inter(t, t2),
                            Some(Null())
                        ),
                        params(id, params_val),
        ...
        context(RelationalContext)
        override fun subst_helper(
            raw_element: Term<ClosureConversionType<LogicInt>>,
            targ: Term<Jarg<Jtype<LogicInt>>>
        ): Goal =
            conde(freshTypedVars { t: Term<Jtype<LogicInt>> ->
                and(
                    raw_element `===` CC_type(t),
                    targ `===` Type(t)
                )
            },
                freshTypedVars { id: Term<LogicInt>, i: Term<PeanoLogicNumber> ->
                    and(
                        (raw_element `===` CC_var(id, i, _f(), _f())),
        ...
        context(RelationalContext)
        override fun targs_helper(
            subst: Term<LogicList<Jarg<Jtype<LogicInt>>>>,
            cc_typ: Term<ClosureConversionType<LogicInt>>,
            res: Term<Jarg<Jtype<LogicInt>>>
        ): Goal =
            conde(freshTypedVars { t: Term<Jtype<LogicInt>>,
                ...
                freshTypedVars { id: Term<LogicInt>, i: Term<PeanoLogicNumber>,
                    ...
                    freshTypedVars { upb: Term<Jtype<LogicInt>>,
                        ...
                        and(
                            cc_typ `===` CC_var(id, i, CC_subst.cc_inter(t, p), lwb),
                            ...
                            conde(
                                ...
                                and(
                                    upb `===` Intersect((t + (new_p + nilLogicList()))),
        ...
        context(RelationalContext)
        override fun targs_pred(
            less_minus_less: (Term<Jtype<LogicInt>>, Term<Jtype<LogicInt>>, Term<LogicBool>) -> Goal,
            targ: Term<Jarg<Jtype<LogicInt>>>, res: Term<LogicBool>
        ): Goal =
            conde(
                freshTypedVars { upb: Term<Jtype<LogicInt>>,
                                 lwb: Term<Jtype<LogicInt>> ->
                    and(
                        (targ `===` Type(Var(_f(), _f(), upb, Some(lwb)))),
        ...
        context(RelationalContext)
        override fun capture_conversion(
            _subtyping: (Term<Jtype<LogicInt>>, Term<Jtype<LogicInt>>, Term<LogicBool>) -> Goal,
            _id: Term<LogicInt>, targs: Term<LogicList<Jarg<Jtype<LogicInt>>>>,
            res: Term<LogicOption<LogicList<Jarg<Jtype<LogicInt>>>>>
        ): Goal =
            res `===` Some(targs)


        context(RelationalContext)
        override fun less_equal_less(
            _subtyping: (Term<Jtype<LogicInt>>, Term<Jtype<LogicInt>>, Term<LogicBool>) -> Goal,
            type_a: Term<Jarg<Jtype<LogicInt>>>,
            type_b: Term<Jarg<Jtype<LogicInt>>>, res: Term<LogicBool>
        ): Goal =
            conde(
                and(
                    type_a `===` type_b,
        ...
        override fun class_int_sub(
            ...
            println("class_int_sub ${st.reify(id_a)}")
            println("              ${st.reify(targs_a)}")
            println("              ${st.reify(id_b)}")
            println("              ${st.reify(targs_b)}")
            conde(and(
                id_a `===` id_b,
                fold_left2o(
                    { acc: Term<LogicBool>, ta: Term<Jarg<Jtype<LogicInt>>>,
                      tb: Term<Jarg<Jtype<LogicInt>>>, res: Term<LogicBool> ->
                        conde(
                            and(
                                acc `===` false.toLogicBool(),
                                res `===` false.toLogicBool()
                            ),
                            and(
                                acc `===` true.toLogicBool(),
                                less_equal_less(
                                    less_minus_less, ta, tb,
                                    res
                                )
                            )
                        )
                ...
                freshTypedVars { super_: Term<LogicOption<Jtype<LogicInt>>> ->
                    and(
                        ...
                        conde(
                            freshTypedVars { targs_b2: Term<LogicList<Jarg<Jtype<LogicInt>>>>,
                                             new_targs_b2: Term<LogicList<Jarg<Jtype<LogicInt>>>> ->
                                and(
                                    conde(
                                        super_ `===` Some(Class_(id_b, targs_b2)),
                                        super_ `===` Some(Interface(id_b, targs_b2))
                                    ),
                                    mapo(
                                        { arg: Term<Jarg<Jtype<LogicInt>>>, res: Term<Jarg<Jtype<LogicInt>>> ->
        ...
        override fun minus_less_minus(
            ...
            println("-<- ${st.reify(type_a)}\n")
            println("    ${st.reify(type_b)}\n")
            conde(
                        ...
                        conde(and(
                            ...
                            freshTypedVars { targs_a: Term<LogicList<Jarg<Jtype<LogicInt>>>> ->
                                and(
                                    ...
                                    conde(
                                        freshTypedVars { id_b: Term<LogicInt>,
                            ...
                            and(
                                ...
                                conde(
                                    ...
                                    and(
                                        ...
                                        type_b `!==` CT.cloneable_t,
                                        conde(
                                            freshTypedVars { tb: Term<Jtype<LogicInt>> ->
                                                and(
                                                    type_b `===` Array_(tb),
                                                    minus_less_minus(
                                                        less_minus_less,
